    ...
    $.extend(FORM, {
        ...
        init: function(opts) {
            ...
            if(FORM.opts['form_url']) {
                var cont = $('<div id="'+FORM.opts['container']+'" class="multistepform" style="display:none; position: absolute; top:0; width: 100%; z-index: 9999;"></div>');
                $('body').append(cont);
                cont.html('<div id="multistepform"><div id="multistepform-container"></div></div>');
                ...
                var data = cont.html();
                cont.html('<div id="multistepform"><div id="multistepform-container">'+data+'</div></div>');
                FORM._show();
            }        
        },
        _show: function() {
